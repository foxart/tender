...
class Browser
{
    ...
    const BROWSER_OPERA = 'OP'; // http://www.opera.com/
    const BROWSER_OPERA_MINI = 'OPM'; // http://www.opera.com/mini/
    const BROWSER_WEBTV = 'WebTV'; // http://www.webtv.net/pc/
    const BROWSER_IE = 'IE'; // http://www.microsoft.com/ie/
    const BROWSER_POCKET_IE = 'PIE'; // http://en.wikipedia.org/wiki/Internet_Explorer_Mobile
    const BROWSER_KONQUEROR = 'KQ'; // http://www.konqueror.org/
    const BROWSER_ICAB = 'iCab'; // http://www.icab.de/
    const BROWSER_OMNIWEB = 'OWeb'; // http://www.omnigroup.com/applications/omniweb/
    const BROWSER_FIREBIRD = 'Fb'; // http://www.ibphoenix.com/
    const BROWSER_FIREFOX = 'FF'; // http://www.mozilla.com/en-US/firefox/firefox.html
    const BROWSER_SHIRETOKO = 'Shiretoko'; // http://wiki.mozilla.org/Projects/shiretoko
    const BROWSER_MOZILLA = 'MZ'; // http://www.mozilla.com/en-US/
    const BROWSER_AMAYA = 'Amaya'; // http://www.w3.org/Amaya/
    const BROWSER_LYNX = 'LY'; // http://en.wikipedia.org/wiki/Lynx
    const BROWSER_SAFARI = 'AS'; // http://apple.com
    const BROWSER_IPHONE = 'IO'; // http://apple.com
    const BROWSER_IPOD = 'iPod'; // http://apple.com
    const BROWSER_CHROME = 'CH'; // http://www.google.com/chrome
    const BROWSER_ANDROID = 'AN'; // http://www.android.com/
    const BROWSER_GOOGLEBOT = 'GBot'; // http://en.wikipedia.org/wiki/Googlebot
    const BROWSER_SLURP = 'YSlurp'; // http://en.wikipedia.org/wiki/Yahoo!_Slurp
    const BROWSER_W3CVALIDATOR = 'W3CVal'; // http://validator.w3.org/
    const BROWSER_BLACKBERRY = 'BB'; // http://www.blackberry.com/
    const BROWSER_ICECAT = 'IC'; // http://en.wikipedia.org/wiki/GNU_IceCat
    const BROWSER_NETSCAPE_NAVIGATOR = 'NNav'; // http://browser.netscape.com/ (DEPRECATED)
    const BROWSER_GALEON = 'Galeon'; // http://galeon.sourceforge.net/ (DEPRECATED)
    const BROWSER_NETPOSITIVE = 'NPos'; // http://en.wikipedia.org/wiki/NetPositive (DEPRECATED)
